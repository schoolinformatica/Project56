    ...
    <div class="row">
        @for($i = 0; $i < count($cars); $i++)
            <div class="col-md-4 col-marg-bottom">
                <div id="{{ $i }}" class="panel panel-default car" onclick="set_modal(this.id)" data-toggle="modal"
                     data-target="#myModal">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <img id="image" style="max-width: 50%; max-height: 50%;" src="/assets/images/car-green.png">
                        </div>
                        <div class="col-md-8">
                            <p id="speed"></p>
