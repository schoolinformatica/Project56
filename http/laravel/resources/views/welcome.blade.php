...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <p>This team is called Cooperatio. We are working on a project called 'Project56' which means that we have to
...
<div class="row">
    <div class="col-md-4">
        ...
        <p>Uploading your data files in order to be processed to certain reports you prefer to have. You can download
    ...
    <div class="col-md-4">
        ...
        <p>You can download data, or better said, reports as one of our services. These reports are created on your
            demand when you upload your datafiles to our servers. For downloading this data it's required to have an
    ...
    <div class="col-md-4">
        ...
        <p>Log in or create an account to get access to our services. As a member you get access to upload data and
            download created reports. These reports are based on the data which is uploaded in you uploaded files.</p>
